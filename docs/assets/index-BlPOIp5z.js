 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,T){var N=C.length;C.push(T);e:for(;0<N;){var H=N-1>>>1,X=C[H];if(0<l(X,T))C[H]=T,C[N]=X,N=H;else break e}}function n(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var T=C[0],N=C.pop();if(N!==T){C[0]=N;e:for(var H=0,X=C.length,bn=X>>>1;H<bn;){var gt=2*(H+1)-1,yl=C[gt],vt=gt+1,er=C[vt];if(0>l(yl,N))vt<X&&0>l(er,yl)?(C[H]=er,C[vt]=N,H=vt):(C[H]=yl,C[gt]=N,H=gt);else if(vt<X&&0>l(er,N))C[H]=er,C[vt]=N,H=vt;else break e}}return T}function l(C,T){var N=C.sortIndex-T.sortIndex;return N!==0?N:C.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,u=i.now();e.unstable_now=function(){return i.now()-u}}var s=[],c=[],h=1,m=null,p=3,y=!1,w=!1,S=!1,A=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,a=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(C){for(var T=n(c);T!==null;){if(T.callback===null)r(c);else if(T.startTime<=C)r(c),T.sortIndex=T.expirationTime,t(s,T);else break;T=n(c)}}function g(C){if(S=!1,d(C),!w)if(n(s)!==null)w=!0,gl(_);else{var T=n(c);T!==null&&vl(g,T.startTime-C)}}function _(C,T){w=!1,S&&(S=!1,f(P),P=-1),y=!0;var N=p;try{for(d(T),m=n(s);m!==null&&(!(m.expirationTime>T)||C&&!Pe());){var H=m.callback;if(typeof H=="function"){m.callback=null,p=m.priorityLevel;var X=H(m.expirationTime<=T);T=e.unstable_now(),typeof X=="function"?m.callback=X:m===n(s)&&r(s),d(T)}else r(s);m=n(s)}if(m!==null)var bn=!0;else{var gt=n(c);gt!==null&&vl(g,gt.startTime-T),bn=!1}return bn}finally{m=null,p=N,y=!1}}var E=!1,x=null,P=-1,B=5,L=-1;function Pe(){return!(e.unstable_now()-L<B)}function sn(){if(x!==null){var C=e.unstable_now();L=C;var T=!0;try{T=x(!0,C)}finally{T?an():(E=!1,x=null)}}else E=!1}var an;if(typeof a=="function")an=function(){a(sn)};else if(typeof MessageChannel<"u"){var ji=new MessageChannel,tc=ji.port2;ji.port1.onmessage=sn,an=function(){tc.postMessage(null)}}else an=function(){A(sn,0)};function gl(C){x=C,E||(E=!0,an())}function vl(C,T){P=A(function(){C(e.unstable_now())},T)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){w||y||(w=!0,gl(_))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(C){switch(p){case 1:case 2:case 3:var T=3;break;default:T=p}var N=p;p=T;try{return C()}finally{p=N}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,T){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var N=p;p=C;try{return T()}finally{p=N}},e.unstable_scheduleCallback=function(C,T,N){var H=e.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?H+N:H):N=H,C){case 1:var X=-1;break;case 2:X=250;break;case 5:X=1073741823;break;case 4:X=1e4;break;default:X=5e3}return X=N+X,C={id:h++,callback:T,priorityLevel:C,startTime:N,expirationTime:X,sortIndex:-1},N>H?(C.sortIndex=N,t(c,C),n(s)===null&&C===n(c)&&(S?(f(P),P=-1):S=!0,vl(g,N-H))):(C.sortIndex=X,t(s,C),w||y||(w=!0,gl(_))),C},e.unstable_shouldYield=Pe,e.unstable_wrapCallback=function(C){var T=p;return function(){var N=p;p=T;try{return C.apply(this,arguments)}finally{p=N}}}})(ns);ts.exports=ns;var xc=ts.exports;/**
 * @license React
...
`,Rd=Object.freeze(Object.defineProperty({__proto__:null,content:Md,metadata:jd},Symbol.toStringTag,{value:"Module"})),Id={title:"Layout Design",order:4},Ad=`
# Layout Design
