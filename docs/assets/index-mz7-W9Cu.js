...
`)})},`code-${m}`))):(o=!0,u=c.trim().slice(3),i=[]):o?i.push(c):l.push(n(c,m))}),O.jsx("div",{className:"markdown-content",children:l})}const Dd={title:"Create Project",order:2},Ld=`
