...
`,Rd=Object.freeze(Object.defineProperty({__proto__:null,content:Dd,metadata:Md},Symbol.toStringTag,{value:"Module"})),Id={title:"Layout Design",order:4},jd=`
# Layout Design
...
Keep it simple!
`,Np=Object.freeze(Object.defineProperty({__proto__:null,content:Tp,metadata:Pp},Symbol.toStringTag,{value:"Module"})),Op=Object.assign({"../content/Analog/Create-Project.ts":Rd,"../content/Analog/Layout-Design.ts":Ad,"../content/Analog/Overview.ts":Wd,"../content/Analog/Schematic-Design.ts":$d,"../content/Digital/Create-Project.ts":Yd,"../content/Digital/Overview.ts":Xd,"../content/Digital/Test-Verify.ts":Zd,"../content/How-To-Use/Basic-Commands.ts":tp,"../content/How-To-Use/Overview.ts":lp,"../content/How-To-Use/Using-Nix.ts":up,"../content/Mixed-Signal/Create-Project.ts":fp,"../content/Mixed-Signal/Overview.ts":mp,"../content/TinyTapeout/Create-Package.ts":yp,"../content/TinyTapeout/Overview.ts":kp,"../content/TinyTapeout/Submit-Package.ts":_p,"../content/Updating-Docs/Build-Deploy.ts":Ep,"../content/Updating-Docs/Markdown-Syntax.ts":Np});function zp(){const e=new Map;for(const[n,t]of Object.entries(Op)){const r=t,a=n.match(/\/content\/([^/]+)\/([^/]+)\.ts$/);if(!a)continue;const[,l,o]=a;e.has(l)||e.set(l,{id:l,title:l.split("-").map(i=>i.charAt(0).toUpperCase()+i.slice(1)).join(" "),pages:[]}),e.get(l).pages.push({id:o,path:`${l}/${o}`,metadata:r.metadata,content:r.content})}return e.forEach(n=>{n.pages.sort((t,r)=>t.metadata.order-r.metadata.order)}),Array.from(e.values()).sort((n,t)=>n.id.localeCompare(t.id))}function Lp(){const[e]=en.useState(()=>zp()),[n,t]=en.useState(""),[r,a]=en.useState(null);en.useEffect(()=>{if(e.length>0&&!n){const o=e[0].pages[0];o&&(t(o.path),a(o))}},[e,n]);const l=o=>{t(o);for(const i of e){const u=i.pages.find(c=>c.path===o);if(u){a(u);break}}};return z.jsxs("div",{className:"app",children:[z.jsx(zd,{sections:e,currentPath:n,onNavigate:l}),z.jsx("main",{className:"content",children:r?z.jsx("article",{className:"article",children:z.jsx(Ld,{content:r.content})}):z.jsx("div",{className:"empty-state",children:z.jsx("p",{children:"Select a page from the sidebar to get started"})})})]})}Ha.createRoot(document.getElementById("root")).render(z.jsx(vc.StrictMode,{children:z.jsx(Lp,{})}));
